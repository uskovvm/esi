...
public class EsiTestContainer extends TestContainer {

    public EsiTestContainer() {
        super();
    ...
    public static class Common extends EsiTestContainer {

        public static final EsiTestContainer.Common INSTANCE = new EsiTestContainer.Common();
